...
// Re-export the pure cascade/bye helpers from their dedicated module so
// existing callers of `@/lib/predictions` keep working. The implementations
// live in lib/predict-cascade.ts to keep them out of the client bundle —
// importing this file pulls in `db/index.ts`, which throws if
// DATABASE_URL is unset, breaking client renders.
export {
  cascadeBracket,
  bracketByeSet,
  type CascadeMap,
  type CascadeMatchup,
} from "./predict-cascade";
